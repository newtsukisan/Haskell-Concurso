...
Para definir choices aplicamos las permutaciones a las combinaciones de los elementos. Cuando tenemos un
solo elemento, pues se queda igual. Luego una forma de implementarlo sería las siguiente:
